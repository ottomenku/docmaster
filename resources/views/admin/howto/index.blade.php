                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button href="/admin/howtoprev/{{$item->id}}" data-remote="false" data-toggle="modal" data-target="#myModal" >
                                                <img src="{{ url($howtoprew_thumb_path.$item->prev)}}" width="50px" height="50px">
                                            </button>   
                                        </td>

                                        <td>
                                            <a href="{{ url('/admin/howto/' . $item->id) }}" title="View howto"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                                            <a href="{{ url('/admin/howto/' . $item->id . '/edit') }}" title="Edit howto"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                            {!! Form::open([
                                                'method' => 'DELETE',
                                                'url' => ['/admin/howto', $item->id],
                            ...
                            <div class="pagination-wrapper"> {!! $howto->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
